...
public class GetPolicys {

	public List<Policy> getPolicyDatas(){
		 List<Policy> news = null;
		ConnNet connNet = new ConnNet();
		String url = "servlet/PolicyServlet";
		...
		try {
			...
			if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
				...
				news = jsonutil.stringFromJsonToPolicys(result);
			} else {
				news = null;
			}
